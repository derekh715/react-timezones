...
function AddNewTimezone() {
  ...
  return (
    <div
      className="bg-none text-gray-800 rounded-lg border-gray-200 border-4 border-dashed p-8 animate-move-up cursor-pointer transition-all hover:-translate-y-4 hover:shadow-lg min-h-48 dark:text-gray-100"
